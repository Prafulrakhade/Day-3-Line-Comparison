...
namespace LineComparison
{
    internal class Program
    {
        ...
        {
            Console.WriteLine("UC 1 calulation the length by using Cartesian System");
        ...
        {
            Console.WriteLine("UC 2 Check Equality of Two Lines based on End Points ");
        ...
        {
            Console.WriteLine("Compare Two Lines Based On End Points ");
